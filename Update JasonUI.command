...
project_dir=${0:A:h}
source_app="$project_dir/.build/app-package/JasonUI.app"
installed_app="/Applications/JasonUI.app"
...
echo
echo "Installing JasonUI in Applications…"
...
echo
echo "JasonUI was updated successfully."
open "$installed_app"
trap - EXIT
